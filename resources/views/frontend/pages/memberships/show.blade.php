    ...
    <div class="membership-container">
        ...
        @if ($membership)
            <div class="membership-status-box">
                ...
                <p><span class="font-semibold">Membership Type:</span> {{ ucfirst($membership->membership_type) }}</p>
                <p><span class="font-semibold">Transaction ID:</span> {{ $membership->transaction_id }}</p>
                <p><span class="font-semibold">Payment Method:</span> {{ $membership->payment_method }}</p>
                ...
                @if ($membership->status === 'rejected')
                    ...
                    <a href="{{ route('membership.create') }}" class="btn-submit mt-4">Reapply for Membership</a>
                @endif
