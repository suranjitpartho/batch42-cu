<x-app-layout>
    <x-slot name="header">
        <h2 class="admin-header-title">
            {{ __('Create Constitution Chapter') }}
        </h2>
    </x-slot>
        ...
        <div class="admin-dashboard-container">
            <div class="admin-card">
                <div class="admin-card-body">
                    <form method="post" action="{{ route('admin.constitutions.store') }}" class="admin-form-vertical" x-data="{ activeTab: 'en' }">
                        @csrf
                        ...
                        <div class="admin-form-group">
                            <label for="is_active" class="admin-checkbox-container">
                                <input id="is_active" type="checkbox" class="admin-form-checkbox" name="is_active" value="1" checked>
