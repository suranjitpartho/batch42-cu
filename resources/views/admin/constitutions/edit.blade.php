                    ...
                    <form method="post" action="{{ route('admin.constitutions.update', $constitution) }}" class="admin-form-vertical" x-data="{ activeTab: 'en' }">
                        ...
                        <div x-show="activeTab === 'en'" class="admin-tab-content admin-form-vertical">
                            <div class="admin-form-group">
                                ...
                                <input id="chapter_name_en" name="chapter_name_en" type="text" class="admin-form-input" value="{{ old('chapter_name_en', $constitution->getTranslation('chapter_name', 'en')) }}" />
                            ...
                            <div class="admin-form-group">
                                ...
                                <textarea id="content_en" name="content_en" class="admin-form-input" rows="6">{{ old('content_en', $constitution->getTranslation('content', 'en')) }}</textarea>
                        ...
                        <div x-show="activeTab === 'bn'" class="admin-tab-content admin-form-vertical" style="display: none;">
                            <div class="admin-form-group">
                                ...
                                <input id="chapter_name_bn" name="chapter_name_bn" type="text" class="admin-form-input" value="{{ old('chapter_name_bn', $constitution->getTranslation('chapter_name', 'bn')) }}" />
                            ...
                            <div class="admin-form-group">
                                ...
                                <textarea id="content_bn" name="content_bn" class="admin-form-input" rows="6">{{ old('content_bn', $constitution->getTranslation('content', 'bn')) }}</textarea>
