        ...
        <div class="admin-dashboard-container">
            <div class="admin-card">
                <div class="admin-card-body">
                    <form action="{{ route('admin.notices.store') }}" method="POST" class="admin-form-vertical">
                        @csrf
                        ...
                        <div class="admin-form-group">
                            ...
                            <textarea id="content" name="content" class="admin-form-textarea" required>{{ old('content') }}</textarea>
                            @error('content')
                                <p class="admin-input-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="admin-form-group">
                            ...
                            <div class="admin-checkbox-container">
                                <input type="checkbox" id="members_only" name="members_only" value="1" class="admin-form-checkbox">
